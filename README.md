...
[![R-CMD-check](https://github.com/modes-cemi/dimControl/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/modes-cemi/dimControl/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
- Bernardini F., Mittleman J., Rushmeier H., Silva C., Taubin G. (1999).
  ...
  transactions on visualization and computer graphics*, 5(4), 349-359.
...
- Lafarge T., Pateiro-López B., Possolo A., Dunkers J. (2014). R
  ...
  Using the $\alpha$-Shape. *Journal of Statistical Software*, 56, 1-19.

- Lecigne B., Delagrange S., Messier C. (2018). Exploring trees in three
  dimensions: VoxR, a novel voxel-based R package dedicated to analysing
  the complex arrangement of tree crowns. *Annals of Botany*, 121,
  589-601.
...
- Pateiro-López B., Rodríguez-Casal A. (2010). Generalizing the convex
  hull of a sample: the R package alphahull. *Journal of Statistical
  Software*, 34, 1-28.

- Roussel J.R., Auty D. (2023). *lidR: Airborne LiDAR Data Manipulation
  and Visualization for Forestry Applications*. R package version 3.1.0.
