...
- [`angleBetweenUnitVectors()`](https://modes-cemi.github.io/dimControl/reference/angleBetweenUnitVectors.md)
...
- [`angleFromAxisDirection()`](https://modes-cemi.github.io/dimControl/reference/angleFromAxisDirection.md)
...
- [`panelPoints`](https://modes-cemi.github.io/dimControl/reference/panelPoints.md)
  : Simulated point cloud of a steel panel
- [`rad2deg()`](https://modes-cemi.github.io/dimControl/reference/rad2deg.md)
